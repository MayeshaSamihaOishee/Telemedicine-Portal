...
public class Doctor_MyAnswer extends Activity {
    ...
    public static final String GET_URL = "http://ehealth.mdtauhidul.me/getData_MyAnswer.php";
    public static final String Send_Url = "http://ehealth.mdtauhidul.me/update_temp_myAnswer.php";

    @Override
    protected void onCreate(Bundle savedInstanceState){
        super.onCreate(savedInstanceState);
        setContentView(R.layout.doctor_activity_my_answer);
